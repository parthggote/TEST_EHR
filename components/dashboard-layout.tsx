      ...
      <div className={cn("fixed inset-0 z-50 lg:hidden", sidebarOpen ? "block" : "hidden")}>
        ...
        <div className="fixed left-0 top-0 h-full w-64 bg-card border-r border-border">
          <div className="flex items-center justify-between p-4 border-b border-border">
            <h1 className="text-lg font-semibold text-foreground">Epic FHIR</h1>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-card border-r border-border">
          <div className="flex items-center px-4 py-4 border-b border-border">
            <h1 className="text-lg font-semibold text-foreground">Epic FHIR Dashboard</h1>
          </div>
          ...
          <div className="flex items-center justify-between px-4 py-3">
            <div className="flex items-center">
              ...
              <div className="relative max-w-md">
                ...
                <Input placeholder="Search patients, appointments..." className="pl-10 w-full md:w-80" />
              </div>
            </div>
