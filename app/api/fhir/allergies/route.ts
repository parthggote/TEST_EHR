/**
 * FHIR Allergies API Route
 * Handles fetching allergies for a specific patient
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    const bundle = await epicClient.getPatientAllergies(accessToken, patientId);
    ...
    return NextResponse.json(
      {
        error: 'Failed to fetch allergy data',
