/**
 * FHIR Medications API Route
 * Handles fetching medication requests for a specific patient
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    const bundle = await epicClient.getPatientMedications(accessToken, patientId);
